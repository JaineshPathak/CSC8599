...
{
	camera = new Camera(0.0f, 0.0f, 0.0f, Vector3(0, 100.0f, 550.0f));
	...
	for (int i = 0; i < 5; ++i)
	{
		...
		s->SetColor(Vector4(1.0f, 1.0f, 1.0f, 0.5f));
		s->SetTransform(Matrix4::Translation(Vector3(0, 50.0f, -300.0f + 100.0f + 100 * i)));
